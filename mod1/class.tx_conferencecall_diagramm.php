 ...
 *
 *
 *   43: class  tx_conferencecall_diagramm
 ...
 *
 */
class  tx_conferencecall_diagramm {
	...
	protected function text($size, $x1 ,$y1, $text, $color)	{
		return '<div style="position:absolute;left:'.$x1.'px;top:'.$y1.'px;"><span class="tx_conferencecall_diagramm-text" style="color:'.$color.';font-size:'.$size.';">'.$text.'</span></div>';
	}
	...
	public function draw($arr, $names = null, $values = null) {
		...
		// Diagram begin
		$diagramm = '<div class="tx_conferencecall_diagramm-border" style="border:1px solid black;width:' . $width . 'px;">';
		$diagramm.= '<div class="tx_conferencecall_diagramm-inhalt" style="position:relative;left:0px;top:0px;width:'.$width.'px;height:'.$height.'px;background:'.$colorBG.';">';
		// Columns
		for($x = 0; $x < $cx; $x++) {
