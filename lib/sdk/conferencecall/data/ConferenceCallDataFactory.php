...
class ConferenceCallDataFactory {
	 ...
	 * 	A Telekom data object
	 */
	static function createGetConferenceTemplateConferenceParticipantsResponse($jsonArray) {
		...
		foreach ($jsonArray as $json)
		{
			...
			$participants[] = new GetConferenceTemplateConferenceParticipantsResponse($participantId, $firstName, $lastName, $number, $email, $isInitiator);
		}
