 ...
 * @subpackage data
 */
class GetConferenceStatusConferenceParticipantsResponse {
	 ...
	 * @param GetConferenceStatusConferenceParticipantsStatusResponse $status Statuscode
	 */
	function __construct($participantId = null, $firstName = null, $lastName = null, $number = null, $email = null, $isInitiator = null, $status = null){
	...
	/**
	 * Sets statuscode
	 * @param GetConferenceStatusConferenceParticipantsStatusResponse $status
